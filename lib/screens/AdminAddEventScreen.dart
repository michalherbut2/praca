...
class _AdminAddEventScreenState extends State<AdminAddEventScreen> {
  ...
  Future<void> _submitEvent() async {
    ...
    try {
      ...
      print('Błąd przy dodawaniu wydarzenia: $e');
    } finally {
      if (mounted) {
            ...
            children: [
              ...
              Card(
                child: SwitchListTile(
                  title: const Text('Umożliw zapisy'),
                  subtitle: const Text('Użytkownicy mogą deklarować uczestnictwo'),
                  value: _allowRsvp,
                  onChanged: (value) => setState(() => _allowRsvp = value),
                  secondary: Icon(
                    _allowRsvp ? Icons.how_to_reg : Icons.block,
                    color: _allowRsvp ? Colors.green : Colors.grey,
                  ),
                ),
              ),
